...
public class photo implements java.io.Serializable, Iphoto {
	...
	/**
	 * Creates an instance of the photo class, storing its file name, caption, array list of tags, and calendar instance
	 * @param fileName String, representing the name of a photo file
	 * @param caption String, representing the caption of a photo
	 */
